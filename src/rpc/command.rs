...
use poise::serenity_prelude::{CreateActionRow, CreateButton, ButtonStyle, CreateQuickModal, CreateInputText, InputTextStyle, CreateInteractionResponse, CreateInteractionResponseMessage, ModalInteraction};
...
pub async fn rpc(
                        ...
                        GetResp {
                            method: super::core::RPCMethod::BotPremiumAdd {
                                ...
                                time_period_hours: match parse_hrs(time_period_str) {
                                    Ok(hrs) => hrs,
                                    Err(e) => {
                                        resp.interaction.create_response(ctx, CreateInteractionResponse::Message(
                            ...
                            method: super::core::RPCMethod::BotForceRemove {
                                ...
                                kick: match parse_bool(kick) {
                                    ...
                                    Err(e) => {
                                        resp.interaction.create_response(ctx, CreateInteractionResponse::Message(
                                            CreateInteractionResponseMessage::default()
                                            .content(format!("**Error parsing `kick`: {}**", e))
                                        )).await?;
                            ...
                            method: super::core::RPCMethod::BotVoteCountSet {
                                ...
                                count: match count_str.parse::<i32>() {
                                    ...
                                    Err(e) => {
                                        resp.interaction.create_response(ctx, CreateInteractionResponse::Message(
                                            CreateInteractionResponseMessage::default()
                                            .content(format!("**Error parsing `count`: {}**", e))
                                        )).await?;
    ...
    match rpc_method.method.handle(
