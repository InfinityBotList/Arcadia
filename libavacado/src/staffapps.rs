...
"#.to_string(),
            questions: vec![
                ...
                StaffAppQuestion {
                    ...
                    para: "Answer the question above with the least amount of code. Use either Go 1.18 or the latest nightly version of Rust for all solutions. Your solution must NOT link to an external resource or library and you MUST justify all code with comments".to_string(),
                    placeholder: "I am...".to_string(),
                    short: false,
                },                         
                StaffAppQuestion {
